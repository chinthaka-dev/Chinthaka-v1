...
class ViewAnswerFromSubmitAnswerDialog: DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return MaterialAlertDialogBuilder(requireContext(),R.style.AlertDialogCustom)
            .setTitle("Great job! That's the right answer")
            .setMessage(R.string.view_answer_from_submit_answer_dialog_message)
